const API_URL = 'https://dummyjson.com/products?limit=194';
    ...
    function renderProducts(products) {
      ...
      productsToShow.forEach((product, index) => {
        ...
        card.className = "group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 animate-fade-in overflow-hidden transform hover:scale-105 hover-lift";
        ...
        card.innerHTML = `
          <div class="relative overflow-hidden">
            ...
            <!-- Quick Actions -->
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 space-y-2">
              <button class="quick-action-btn bg-white/90 hover:bg-white text-gray-700 p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 block" title="Favorite">
                <i class="fas fa-heart"></i>
              </button>
              <button class="quick-action-btn bg-white/90 hover:bg-white text-gray-700 p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 block" title="Compare">
